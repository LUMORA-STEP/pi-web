...
function PiAgentTitle() {
  ...
  const target = showVersion ? `${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.0.0"}p${process.env.NEXT_PUBLIC_PI_VERSION ?? "0.0.0"}` : "Pi 智能助手";
          ...
          return (
            <div ref={wtDropdownRef} style={{ position: "relative", marginTop: 6 }}>
              <button
                ...
                title={currentWt ? `切换工作树：${currentWt.path}` : "切换工作树"}
                style={{
                  width: "100%",
                  height: 29,
                  boxSizing: "border-box",
              ...
              >
                ...
                />
                {currentWt?.isMain && (
                  <span style={{ flexShrink: 0, color: "var(--text-dim)", fontSize: 10 }}>主分支</span>
                )}
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            {wt.isMain && <span style={{ flexShrink: 0, color: "var(--text-dim)", fontSize: 10 }}>主分支</span>}
                          </button>
                          {!wt.isMain && (
                            <button
                              onClick={() => void handleRemoveWorktree(wt.path, false)}
                              disabled={wtBusy}
                              title={`移除工作树检出 ${wt.path}；分支将保留`}
                              style={{
                                display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div
              ...
              title={isRunning ? `${title} · 智能助手运行中…` : isUnread ? `${title} · 新活动` : title}
            >
